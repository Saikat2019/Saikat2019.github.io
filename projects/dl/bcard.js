...
'<div class="col-md-4 animate-box"  style="padding-bottom: 40px;">\
			  <!-- BEGIN: card -->\
			  <div class="card" data-effect="color">\
			    <button class="card__save  js-save" type="button">\
			      <i class="fa  fa-bookmark"></i>\
			    ...
			    <figure  class="card__image">\
			      <img src="androidDev.jpg" alt="Short description">\
			    </figure>\
			    <div class="card__header">\
			      <figure class="card__profile">\
			        <img src="ghdp.jpg" alt="Short description">\
			      </figure>\
			    </div>\
			    <div class="card__body" >\
			      <h3 class="card__name" > abcdefghij klmnopqrstuvwxyz </h3>\
			      <p class="card__job">astronaut & engineer</p>\
			      <p class="card__bio"> American astronaut, engineer, and the first person to walk on the Moon.</p>\
			    </div>\
			    <div class="card__footer">\
